...
def numberOfWays(arr, k):
    ...
    # TODO: Populate the frequency map and iterate through the array
    ...
    for i in range(len(arr)):
        # TODO: Get the "needed" number
        needed_number = k - arr[i]

        # TODO: See if needed number has NOT been seen
        if needed_number not in seen:
            continue

        # TODO: Assuming it has been seen, add the total number of occurrences to count
