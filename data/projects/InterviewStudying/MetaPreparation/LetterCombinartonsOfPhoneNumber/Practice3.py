...
def letterCombinations(digits):
    ...
    # TODO: Return letter combinations
    res = []

    # TODO: This is backtracking so make a nested function for this
    def backtracking(i, current_string):
        ...
        # TODO: Iterate through every char and recursivelyt call backtracking
        for char in digit_to_char[digits[i]]:
            backtracking(i + 1, current_string + char)

    # TODO: ONLY RUN RECURSIVE CALL IF DIGITS
    if digits:
        backtracking(0, "")
