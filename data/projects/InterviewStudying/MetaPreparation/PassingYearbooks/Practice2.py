...
def findSignatureCounts(arr):
    # TODO: Track the result
    res = []
    # TODO: Iterate through the students arr
    for i in range(len(arr)):
        # TODO: Since every student signs their own book, init at 1
        current_count = 1

        # TODO: Get previous student
        current_student = arr[i]
        prev_student = arr[current_student - 1]

        # TODO: Check if prev_student == current_student
        if prev_student == current_student:
            # TODO: Append to res since we are finished
            res.append(current_count)
            continue
        else:
            current_count += 1
        # TODO: Append current_count to res
        res.append(current_count)
    return res
